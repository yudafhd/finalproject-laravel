...
<body class="fix-header">
    ...
    <body class="fix-header body-for-username">
        ...
        <body class="fix-header">
            <div id="main-wrapper" style="background:#177CBD">
                @if(isset($username))
                @if(!$username)
                                ...
                                <ul class="navbar-nav ml-auto stylish-nav">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="{{ Route('general') }}"><i
                ...
                <footer class="footer container">
                    <ul class="list-unstyled list-inline d-flex">
                        <span class="d-block  ml-auto mr-auto">
                            ...
                            <!-- <li class="list-inline-item">
                                <a
                                    href="https://wa.me/6281357778874?text=Halo%20min%20saya%20dari%20pinterlink">Whatsapp</a>
                            </li> -->
                            <li class="list-inline-item">
                                <a
                                    href="https://www.privacypolicyonline.com/live.php?token=y5qAJnSnWYgVEYdQ9Sw1I9hzEKyBKTBf">Disclaimer</a>
                            </li>
                            <li class="list-inline-item">
                                <a
                                    href="https://privacypolicyonline.com/live.php?token=mIenFLQ37pCFyFXWPw3eoIkHHGMSCuls">Terms
                                    & Condition</a>
                            </li>
                        </span>
                    </ul>
                    <div class="d-flex">
                        <span class="ml-auto mr-auto">
                            ...
                            <a href="https://www.instagram.com/pinterusmedia"><i
                                    class="m-l-40 mdi mdi-instagram"></i></a>
                            <a href="https://www.facebook.com/pinterusmedia"><i id="youtube"
