                ...
                <nav class="navbar navbar-expand-md navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul class="navbar-nav mr-auto stylish-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ Route('general.theme') }}">
                                    <i class="mdi mdi-format-paint"></i>
                                    Tema</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ Route('general.dashboard') }}">Dashboard</a>
                            </li>
                            @if (!auth()->user()->userPurchaseMapNotExpired()->first())
                            <li class="nav-item">
                                <a class="nav-link" href="{{ Route('account.upgrade') }}"><span
        ...
        <footer class="footer container">
            <ul class="list-unstyled list-inline d-flex">
                <span class="d-block  ml-auto mr-auto">
                    ...
                    <li class="list-inline-item">
                        <a href="https://privacypolicyonline.com/live.php?token=mIenFLQ37pCFyFXWPw3eoIkHHGMSCuls">Terms
                            & Condition</a>
                    </li>
                </span>
            </ul>
