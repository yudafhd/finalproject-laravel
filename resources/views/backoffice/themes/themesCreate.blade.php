                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cover_colour" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="select-beast" name="theme_transaction" >
                                        <option value="free" {{ old('theme_transaction') == 'free' ? 'selected' : ''}}>free</option>
                                        <option value="pay" {{ old('theme_transaction') == 'pay' ? 'selected' : ''}}>pay</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select  class="select-beast" name="status">
                                        ...
                                        <option value="0" {{ old('status') == 'disabled' ? 'selected' : '' }}>disabled</option>
                                    </select>
                                </div>
                            </div>
                        </div>
