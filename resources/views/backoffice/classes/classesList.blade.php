        ...
        <div class="card">
           <div class="card-body">
            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade" id="nav-import" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div class="card">
                        <div class="card-body">
                            <form class="form-inline" method="POST" action="{{ Route('kelas.import') }}"
                ...
                <div class="tab-pane fade" id="nav-download" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ Route('kelas.export') }}" class="btn btn-primary">Download Excel</a>
                        </div>
                    </div>
                </div>
            </div>
