    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{Route('satuan.create')}}" class="btn btn-primary waves-effect waves-light m-b-20 float-right">
                                    ...
                                    <div class="dropdown" style="float: right">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item"
                                                href="{{Route('satuan.edit', $item->id)}}">Update</a>
                                                <form method="POST" action="{{Route('satuan.destroy', $item->id)}}">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
